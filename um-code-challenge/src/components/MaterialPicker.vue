<template>
  <v-container>
    ...
    <v-layout xs12>
      ...
      <v-flex xs12
              sm6>
        <ImageCrossfader :images="colorList"
                         :visibleImageId="selected"
                         :key="selected" />
      </v-flex>
    </v-layout>
  </v-container>
  ...
  data: () => ({
    colorList: [
      ...
      },
      {
        ...
        image: "https://images.ctfassets.net/7cnpidfipnrw/6htIQz4XwYk4IjxXKmfcBx/8f075901e21cc164b5e9525497c1b643/5-color-PLA-Transparent.png?w=1324"
      },
    ],
